/* 1 - Solicita un nombre, la edad y muestra por consola el mensaje "Hola ____, tienes ____ años y 
el año que viene tendrás ____ años"
Realiza el ejercicio con prompt(mensaje) y haz uso de los template strings */

//let nombre = prompt('Introduzca su nombre');
//let edad = parseInt(prompt('Introduzca su edad'));

//El parseInt cambia el valor por un entero.

//console.log(`Hola ${nombre}, tienes ${edad} y el año que viene tendras ${edad+1}`);
...
/* let figure = prompt('Ingrese la figura a trabajar, triangle, rectangle or radius');
...
switch(figure){
    case 'triangle':
        base = prompt('Ingrese la base de la triangulo');
        height = prompt('Ingrese la altura del triangulo');
        console.log(`El area del triangulo es ${(base * height)/2}`); //si divido pongo las multiplicacion entre parentesis
        break;

    case 'rectangle':
        base = prompt('Ingrese la base del rectangulo');
        height = prompt('Ingrese la altura del rectangulo');
        console.log(`El area del rectangulo es de ${base * height}`);
        break;

    case 'circle':
        radius = prompt('Ingrese el radio del circulo');
        console.log(`El area del rectangulo es de ${Math.PI * Math.pow(radius, 2)}`);
        break;
...
console.log(`La cantidad de numeros introducidos es de ${cont}`); */
...
for(const number of array1){
    ...
    if(result % 2 == 0){
        ...
        arrayPares.push(result);

    }else{

        arrayImpares.push(result);
...
console.log(`Tus palabras tiene ${vocales} vocales, ${consonantes} consonantes y tiene un total ${palabra.length} letras.`); */
...
if(colors.indexOf(color) !== -1){
    ...
    console.log('Tu color no se encuentra definido');
